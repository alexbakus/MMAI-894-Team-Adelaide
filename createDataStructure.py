...
root_export = 'data_3C_'+'from_'+root_source+'_to_'+str(resize_resolution)+'/'
...
train_bacteria_export = train_export+'bacteria/'
if not os.path.exists(train_bacteria_export):
    os.makedirs(train_bacteria_export)

train_virus_export = train_export+'virus/'
if not os.path.exists(train_virus_export):
    os.makedirs(train_virus_export)
...
validation_bacteria_export = validation_export+'bacteria/'
if not os.path.exists(validation_bacteria_export):
    os.makedirs(validation_bacteria_export)

validation_virus_export = validation_export+'virus/'
if not os.path.exists(validation_virus_export):
    os.makedirs(validation_virus_export)
