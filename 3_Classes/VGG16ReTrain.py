...
NAME = 'VGG16Retrain_'+sourceSize+model_time
...
#Load the VGG model
vgg16_conv = VGG16(weights='imagenet', include_top=False, input_shape=input_shape)
...
model_time = datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
mdoel_name = 'VGG16_'+str(img_width)+'_'+str(batch_size)+lr_string+'_'+ model_time
